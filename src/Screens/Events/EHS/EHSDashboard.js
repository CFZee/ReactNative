...
import EHSTechnicalSession from './EHSTechnicalSession'; 
import EHSAboutTheEvent from './EHSAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import EHSAbstract from './EHSAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import EHSAbstractDetail from './EHSAbstractDetail';
...
import EHSTechnicalAndSpecialEvents from './EHSTechnicalAndSpecialEvents'
...
export class EHSDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('EHSTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('EHSAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('EHSAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const EHSTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:EHSTechnicalAndSpecialEvents},
  EHSTechnicalSession:{screen:EHSTechnicalSession},
  SpeakerDetail:{
...
const EHSAbstractNav = createStackNavigator(
  {
    Home: {
      screen: EHSAbstract,
    },
...
const EHSAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: EHSAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    EHSAboutTheEvent:{
      screen:EHSAboutTheEventNav
    },
    EHSTechnicalAndSpecialEvents: {
      screen: EHSTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
