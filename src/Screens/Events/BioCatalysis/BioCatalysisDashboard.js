...
import BioCatalysisTechnicalSession from './BioCatalysisTechnicalSession'; 
import BioCatalysisAboutTheEvent from './BioCatalysisAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import BioCatalysisAbstract from './BioCatalysisAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import BioCatalysisAbstractDetail from './BioCatalysisAbstractDetail';
...
import BioCatalysisTechnicalAndSpecialEvents from './BioCatalysisTechnicalAndSpecialEvents'
...
export class BioCatalysisDashboard extends Component {
            ...
            <Header transparent androidStatusBarColor='transparent' style={{height:100}}>
                ...
                <Button style={{height:heightPercentageToDP('10%'),width:widthPercentageToDP('10%')}} transparent onPress={() => this.props.navigation.dispatch(StackActions.popToTop())}>
                    ...
                    <Body style={{flex:1,marginLeft:60,alignSelf:'center'}}>
                        <Text style={{alignItems:'center',marginLeft:-50,marginLeft:-50,color:themes.colors.INIT_COLOR_White,width:widthPercentageToDP('85%'),fontFamily:themes.fonts.INIT_FONT_Family,fontSize:14}} >Workshop on Bio-Catalysis Dashboard</Text>
                        </Body>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('BioCatalysisTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('BioCatalysisAbstract')}>
                        ...
                        <Button rounded
            style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}
            onPress={() => this.props.navigation.navigate('BioCatalysisAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
               ...
               <Right style={{flex:1,alignSelf:'center'}}/>
                        ...
                        <Button rounded  onPress={()  => this.props.navigation.navigate('AboutIGCW')}
            style={{marginTop:25,marginLeft: 15,marginBottom:10,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff',alignItems:'center'}}>
              <Left style={{flex:1,alignSelf:'center'}}/>
              <Body style={{flex:1,alignSelf:'center'}}>
...
const BioCatalysisTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:BioCatalysisTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  BioCatalysisAbstract:{
    screen:BioCatalysisAbstract
  },
  BioCatalysisAbstractDetail:{
    screen:BioCatalysisAbstractDetail
  },
  BioCatalysisTechnicalSession:{screen:BioCatalysisTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    BioCatalysisAboutTheEvent:{
      screen:BioCatalysisAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const BioCatalysisAbstractNav = createStackNavigator(
  {
    Home: {
      screen: BioCatalysisAbstract,
    },
...
const BioCatalysisAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: BioCatalysisAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    BioCatalysisAboutTheEvent:{
      screen:BioCatalysisAboutTheEventNav
    },
    BioCatalysisTechnicalAndSpecialEvents: {
      screen: BioCatalysisTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  BioCatalysisAbstract:{
    screen:BioCatalysisAbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
