...
export default class LeadershipSummitTechnicalSession extends Component {

  sessionScreen = () => {
    const { navigation } = this.props;
    this.props.navigation.navigate('SpeakerDetail', {
      eventSpeakerName:navigation.getParam('eventSpeakerName'),
      eventSpeakerDesignation: navigation.getParam('eventSpeakerDesignation'),
      eventSpeakerOrganization:navigation.getParam('eventSpeakerOrganization'),
      eventSpeakerImage:navigation.getParam('eventSpeakerImage'),
    })
  }
  ...
  render() {
    ...
    const event_location = "Auditorium Hall";
    ...
    return (
      <Container style ={styles.container}>
        <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} colors={['#88BE49', '#447A47']} style={styles.LinearGradient}>
          ...
          <Content>
          <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('LeadershipSummitAbstract')}>
...
<Separator transparent style={styles.container2}>
          ...
          <TouchableWithoutFeedback onPress={() => this.sessionScreen()}>
          <CardItem>
