...
export default class AbstractDetail extends Component{
  render () {
    ...
    const abstract_description = navigation.getParam('LeadershipSummitAbstractDetail');
    ...
    return(
      ...
      <Header  transparent androidStatusBarColor='transparent'
        style={{height:180}}>
          ...
          <Body style={{flex:1,marginBottom:-20}}>
      ...
      <CardItem style={styles.shadow1}>
       <View>
              <View>
            <Text style={{fontWeight:'bold',fontSize: 18,color: themes.colors.INIT_COLOR_Blue,textAlign:'left',paddingLeft:15,paddingBottom:5,fontFamily: themes.fonts.INIT_FONT_Family}}>
             {user_name}
                </Text>
                </View>
                <View>
                  <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_XL,textAlign:'left',paddingLeft:15,paddingBottom:5,color: themes.colors.INIT_COLOR_Grey,fontFamily: themes.fonts.INIT_FONT_Family}}>
                  {user_designation}
                </Text>
                </View>
                <View>
        ...
        <Text style={{fontSize:15,paddingLeft:20,marginTop:10,textAlign:'auto',color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family}}>
          Abstract:</Text>
        <CardItem >
            <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_XL,padding:5,marginTop:-10,textAlign:'auto',color: themes.colors.INIT_COLOR_Grey,fontFamily: themes.fonts.INIT_FONT_Family}}>
             {abstract_name}
              </Text>
          </CardItem>
        <CardItem >
            <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_L,padding:5,marginTop:-10,textAlign:'auto',color: themes.colors.INIT_COLOR_Grey,fontFamily: themes.fonts.INIT_FONT_Family}}>
