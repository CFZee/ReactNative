...
import PollutionTechnicalSession from './PollutionTechnicalSession'; 
import PollutionAboutTheEvent from './PollutionAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import PollutionAbstract from './PollutionAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import PollutionAbstractDetail from './PollutionAbstractDetail';
...
import PollutionTechnicalAndSpecialEvents from './PollutionTechnicalAndSpecialEvents'
...
export class PollutionDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('PollutionTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('PollutionAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('PollutionAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const PollutionTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:PollutionTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  PollutionAbstract:{
    screen:PollutionAbstract
  },
  PollutionAbstractDetail:{
    screen:PollutionAbstractDetail
  },
  PollutionTechnicalSession:{screen:PollutionTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    PollutionAboutTheEvent:{
      screen:PollutionAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const PollutionAbstractNav = createStackNavigator(
  {
    Home: {
      screen: PollutionAbstract,
    },
...
const PollutionAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: PollutionAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    PollutionAboutTheEvent:{
      screen:PollutionAboutTheEventNav
    },
    PollutionTechnicalAndSpecialEvents: {
      screen: PollutionTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
