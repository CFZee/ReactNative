...
// }
session6InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Welcome to Green Chemistry & Engg. Tools, Techniques & Metrics ",
    eventBody: "Welcome to Green Chemistry & Engg. Tools, Techniques & Metrics ",
    eventLocation:"",
     eventDate: "16th October 2019",
    eventSpeakerName:"Dr. Debabrata Maiti",
    eventSpeakerImage:"http://165.22.216.45/wp-content/uploads/2019/10/DebabrataMaiti.jpg",
    eventSpeakerDesignation: 'Associate Professor',
    eventSpeakerOrganization:'Department, IIT-Bombay',
  })
}
session6InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Keynote: Introduction to the ACS Green Chemistry Institute Pharmaceutical Round Table (ACS GCIPR): MSD Perspective    ",
    eventBody: "Introduction to GCIPR (Philosophy, Commitment & initiatives), Sharing Merck's experience    ",
    eventLocation:"",
    eventDate: "16th October 2019",
...
session7InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Measures of Green Chemistry Performance    ",
    eventBody: "Introducing Green Chemistry Metrics, PMI",
    eventLocation:"",
    eventDate: "16th October 2019",
...
session8InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Solvents and Reagents – Making more Sustainable Choices    ",
    eventBody: "Introduce Solvent Selection Guide & Reagent Guide alogn with examples & exercise    ",
    eventLocation:"",
    eventDate: "16th October 2019",
    eventSpeakerName:"Dr. David Constable  ",
    eventSpeakerImage:"http://165.22.216.45/wp-content/uploads/2019/10/David-Constable.png",
...
session10InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Green Chemistry Tools and Technologies for Chemical Synthesis    ",
    eventBody: "Industrial Case Studies on Green Chemistry & Engg. from Pfizer    ",
    eventLocation:"",
    eventDate: "16th October 2019",
...
session9InfoScreen = () => {
  this.props.navigation.navigate('GCETechnicalSession', {
    eventName: "Applications of Green Chemistry Principles in Chemical Development    ",
    eventBody: "Industrial Case Studies on Green Chemistry & Engg. from BMS    ",
    eventLocation:"",
    eventDate: "16th October 2019",
    eventSpeakerName:"Dr. Vaidyanathan Rajappa ",
    eventSpeakerDesignation:'Group Director - Chemical',
    eventSpeakerOrganization:'Synthetic & Analytical Development, Bristol-Myers Squibb, India',
    eventSpeakerImage:"",
  })
}
    render() {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                <Button style={{height:heightPercentageToDP('10%'),width:widthPercentageToDP('10%')}} transparent onPress={() => this.props.navigation.dispatch(StackActions.popToTop())}>
                    ...
                    <Body style={{flex:1,marginLeft:60,alignSelf:'center'}}>
                        <Text style={{alignItems:'center',marginLeft:-50,marginLeft:-50,color:themes.colors.INIT_COLOR_White,width:widthPercentageToDP('82%'),fontFamily:themes.fonts.INIT_FONT_Family,fontSize:14}} > Workshop on Green Chemistry</Text>
                        <Text style={{alignItems:'center',marginLeft:-50,marginLeft:-50,color:themes.colors.INIT_COLOR_White,width:widthPercentageToDP('80%'),fontFamily:themes.fonts.INIT_FONT_Family,fontSize:14}} >Tools & Metrics Tools Dashboard</Text>
                        </Body>
    ...
    <View>
          ...
          <LinearGradient colors={['#88BE49','#447A47']} style={{alignSelf:'stretch'}}>
                  ...
                  Welcome to Green Chemistry & Engg. Tools, Techniques & Metrics by Dr. Debabrata Maiti, Chemistry, Associate Professor, Department, IIT-Bombay	
                 </Text>
                 </View>
                <View>
          ...
          <LinearGradient colors={['#88BE49','#447A47']} style={{alignSelf:'stretch'}}>
                  ...
                  <Body style={{flex:1}}>
                      <View style={{flexDirection:'column',marginLeft:9,marginRight:-60,paddingTop:15,marginBottom:15}}>
                            <View>
                            <Text style={{width:widthPercentageToDP('60%'),fontSize: themes.fonts.INIT_FONT_SIZE_XL,color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family,marginRight:-50}}>
                            Keynote: Introduction to the ACS Green Chemistry Institute Pharmaceutical Round Table (ACS GCIPR): MSD Perspective
                 </Text>
                 </View>
                <View>
                <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_L,paddingTop:5,color: themes.colors.INIT_COLOR_Indigo,fontFamily: themes.fonts.INIT_FONT_Family}}>
          ...
          <LinearGradient colors={['#88BE49','#447A47']} style={{alignSelf:'stretch'}}>
                  ...
                  <Body style={{flex:1}}>
                      <View style={{flexDirection:'column',marginLeft:9,marginRight:-60,paddingTop:15,marginBottom:15}}>
                            <View>
                            <Text style={{width:widthPercentageToDP('60%'),fontSize: themes.fonts.INIT_FONT_SIZE_XL,color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family,marginRight:-50}}>
                            Solvents and Reagents – Making more Sustainable Choices
                            </Text>
                 </View>
                <View>
                <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_L,paddingTop:5,color: themes.colors.INIT_COLOR_Indigo,fontFamily: themes.fonts.INIT_FONT_Family}}>
          ...
          <LinearGradient colors={['#88BE49','#447A47']} style={{alignSelf:'stretch'}}>
                  ...
                  <Body style={{flex:1}}>
                      <View style={{flexDirection:'column',marginLeft:9,marginRight:-60,paddingTop:15,marginBottom:15}}>
                            <View>
                            <Text style={{width:widthPercentageToDP('60%'),fontSize: themes.fonts.INIT_FONT_SIZE_XL,color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family,marginRight:-50}}>
                            Applications of Green Chemistry Principles in Chemical Development
                 </Text>
                 </View>
                <View>
                <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_L,paddingTop:5,color: themes.colors.INIT_COLOR_Indigo,fontFamily: themes.fonts.INIT_FONT_Family}}>
