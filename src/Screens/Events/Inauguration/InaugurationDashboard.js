...
import InaugurationTechnicalSession from './InaugurationTechnicalSession'; 
import InaugurationTechnicalSession1 from './InaugurationTechnicalSession1'; 
import InaugurationAboutTheEvent from './InaugurationAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import InaugurationAbstract from './InaugurationAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import InaugurationAbstractDetail from './InaugurationAbstractDetail';
...
import InaugurationTechnicalAndSpecialEvents from './InaugurationTechnicalAndSpecialEvents'
...
export class InaugurationDashboard extends Component {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('InaugurationTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('InaugurationAbstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('InaugurationAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const InaugurationTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:InaugurationTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  InaugurationTechnicalSession:{screen:InaugurationTechnicalSession},
  InaugurationTechnicalSession1:{screen:InaugurationTechnicalSession1},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    InaugurationAboutTheEvent:{
      screen:InaugurationAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const InaugurationAbstractNav = createStackNavigator(
  {
    Home: {
      screen: InaugurationAbstract,
    },
    Search:{
      screen:Search
    },
    InaugurationAbstractDetail:{
      screen:InaugurationAbstractDetail
    },
    InaugurationAboutTheEvent: {
      screen:InaugurationAboutTheEvent,
  },
...
const InaugurationAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: InaugurationAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    InaugurationAboutTheEvent:{
      screen:InaugurationAboutTheEventNav
    },
    InaugurationTechnicalAndSpecialEvents: {
      screen: InaugurationTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  InaugurationAbstract:{
    screen:InaugurationAbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
