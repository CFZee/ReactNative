...
import ConferenceTechnicalSession from './ConferenceTechnicalSession'; 
import ConferenceAboutTheEvent from './ConferenceAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import ConferenceAbstract from './ConferenceAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import ConferenceAbstractDetail from './ConferenceAbstractDetail';
...
import ConferenceTechnicalAndSpecialEvents from './ConferenceTechnicalAndSpecialEvents'
...
export class ConferenceDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('ConferenceTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('ConferenceAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('ConferenceAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const ConferenceTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:ConferenceTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  ConferenceTechnicalSession:{screen:ConferenceTechnicalSession},
  SpeakerModerator:{
    screen:SpeakerModerator
  },
  ConferenceAbstract:{
    screen:ConferenceAbstract
  },
  ConferenceAbstractDetail:{
    screen:ConferenceAbstractDetail
  },
  Search:{
    screen:Search
  },
...
const FavoritesNav = createStackNavigator(
  {
    ...
    ConferenceAboutTheEvent:{
      screen:ConferenceAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const ConferenceAbstractNav = createStackNavigator(
  {
    Home: {
      screen: ConferenceAbstract,
    },
...
const ConferenceAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: ConferenceAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    ConferenceAboutTheEvent:{
      screen:ConferenceAboutTheEventNav
    },
    ConferenceTechnicalAndSpecialEvents: {
      screen: ConferenceTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
