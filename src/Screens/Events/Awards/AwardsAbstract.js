...
AbstractInfoScreen3 = () => {
  this.props.navigation.navigate('EHSAbstractDetail', {
      ...
      EHSAbstractDetail:"EHScatalysis over past few years has matured as an essential, competitive and cost-effective alternative for chemical synthesis, in diverse applications, across industries. With unparallel selectivity and EHSdegradable nature, they can furnish the Sustainable Processes. Hydrolases, although most explored class of enzymes at academic level, are becoming now, Industrially proven candidates. Moreover, successful to set excellent examples for other Classes of EHScatalyst, to evolve expedite way. Irrespective of whether its Pharmaceutical or Speciality chemical industry, the knowledge is available now, to take a EHScatalytic process from Concept to Commercialization including downstream regulatory requirements.  ",
      abstractName:"EHScatalysis – Sustainable Solution Across Industries "
  })
}
AbstractInfoScreen5 = () => {
  this.props.navigation.navigate('EHSAbstractDetail', {
