...
export default class PharmaAboutTheEvent extends Component {
  ...
  render() {
    return (
      ...
      <Left >
        ...
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green,paddingLeft:10}}/>
        <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To share various business, regulatory, supply chain dynamics happening globally in Pharma Industry related to sustainability.To share Green Chemistry initiatives, successful case studies, tools, techniques & best practices by large pharma companies.To discuss need & relevance of Process Safety in Pharma Industry and share best practices.To share recent innovations like Flow Chemistry & its successful implementation in Pharma Industry. In Green Chemistry, identify challenges, gaps, mindset issues and discuss learnings from experiences of India & China.		
              </Text>
          </CardItem>
