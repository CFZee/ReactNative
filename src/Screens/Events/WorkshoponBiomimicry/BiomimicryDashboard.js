...
import BiomimicryTechnicalSession from './BiomimicryTechnicalSession'; 
import BiomimicryAboutTheEvent from './BiomimicryAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import BiomimicryAbstract from './BiomimicryAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import BiomimicryAbstractDetail from './BiomimicryAbstractDetail';
...
import BiomimicryTechnicalAndSpecialEvents from './BiomimicryTechnicalAndSpecialEvents'
...
export class BiomimicryDashboard extends Component {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('BiomimicryTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('BiomimicryAbstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('BiomimicryAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const BiomimicryTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:BiomimicryTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  BiomimicryAbstract:{
    screen:BiomimicryAbstract
  },
  BiomimicryAbstractDetail:{
    screen:BiomimicryAbstractDetail
  },
  BiomimicryTechnicalSession:{screen:BiomimicryTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    BiomimicryAboutTheEvent:{
      screen:BiomimicryAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const BiomimicryAbstractNav = createStackNavigator(
  {
    Home: {
      screen: BiomimicryAbstract,
    },
...
const BiomimicryAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: BiomimicryAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    BiomimicryAboutTheEvent:{
      screen:BiomimicryAboutTheEventNav
    },
    BiomimicryTechnicalAndSpecialEvents: {
      screen: BiomimicryTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
