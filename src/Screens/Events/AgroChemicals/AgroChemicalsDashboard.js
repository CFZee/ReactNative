...
import AgroChemicalsTechnicalSession from './AgroChemicalsTechnicalSession'; 
import AgroChemicalsAboutTheEvent from './AgroChemicalsAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import AgroChemicalsAbstract from './AgroChemicalsAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import AgroChemicalsAbstractDetail from './AgroChemicalsAbstractDetail';
...
import AgroChemicalsTechnicalAndSpecialEvents from './AgroChemicalsTechnicalAndSpecialEvents'
...
export class AgroChemicalsDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Header transparent androidStatusBarColor='transparent' style={{height:100}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('AgroChemicalsTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('AgroChemicalsAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('AgroChemicalsAboutTheEvent')}>
...
const AgroChemicalsTechnicalAndSpecialEventsNav = createStackNavigator ({
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  AgroChemicalsAbstract:{
    screen:AgroChemicalsAbstract
  },
  AgroChemicalsAbstractDetail:{
    screen:AgroChemicalsAbstractDetail
  },
  Home:{screen:AgroChemicalsTechnicalAndSpecialEvents},
  AgroChemicalsTechnicalSession:{screen:AgroChemicalsTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    AgroChemicalsAboutTheEvent:{
      screen:AgroChemicalsAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const AgroChemicalsAbstractNav = createStackNavigator(
  {
    Home: {
      screen: AgroChemicalsAbstract,
    },
...
const AgroChemicalsAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: AgroChemicalsAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    AgroChemicalsAboutTheEvent:{
      screen:AgroChemicalsAboutTheEventNav
    },
    AgroChemicalsTechnicalAndSpecialEvents: {
      screen: AgroChemicalsTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  AgroChemicalsAbstract:{
    screen:AgroChemicalsAbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
