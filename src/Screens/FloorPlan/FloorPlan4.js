...
export default class FloorPlan4 extends Component {
    ...
    render() {
      return (
        <Container>
          ...
          <View style={styles.item}>
              <View>
              <ImageZoom style={{flex:1,resizeMode:'stretch'}} cropWidth={Dimensions.get('window').width}
                       cropHeight={Dimensions.get('window').height}
                       imageWidth={400}
                       imageHeight={400}>
                <Image style={{width:null, height:null ,flex:1}}
                       source={require('../FloorPlan/floorPlan.png')}/>
            </ImageZoom>    
                          </View>
        </View>
          {/* <FlatList
