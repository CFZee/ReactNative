...
export default class BioCatalysisAboutTheEvent extends Component {
...
//   );
  ...
  render() {
    return (
      ...
      <Left >
        <Icon name ='calendar' style={{fontSize:20,color:themes.colors.INIT_COLOR_Green}}/>
        <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>
          Day 2, 17th October</Text>
        </Left></CardItem>
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/><Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>Seminar Hall 12</Text>
          </Left>
          </CardItem>
          <CardItem style={{paddingLeft:5,paddingTop:5}}>
            <Text style={{fontFamily:themes.fonts.INIT_FONT_Family,fontSize:themes.fonts.INIT_FONT_SIZE_M}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To introduce the basic concept, fundamentals and potential applications of Biocatalysis. To share readily available & latest innovations on bio-catalysts, bio-catalysis technologies with successful case studies. To share bio-catalysis initiatives, best practices and case studies from industry. To discuss challenges of scaling-up biocatalysis processes and how to overcome them.		
              </Text>
          </CardItem>
