...
class InaugurationD2TechnicalAndSpecialEvents extends Component {
//   constructor() {
//     super();
//     this.state = { Day1: []  },
//     this.state = { Day2: []  },
...
session1InfoScreen = () => {
  this.props.navigation.navigate('InaugurationD2TechnicalSession', {
    eventName: "Welcome & Acknowledgements    ",
    eventBody: "Welcome & Acknowledgements    ",
    eventLocation:"",
...
session2InfoScreen = () => {
  this.props.navigation.navigate('InaugurationD2TechnicalSession', {
    ...
    eventBody: "Creating Context for IGCW2019    ",
    eventLocation:"",
    eventDate: "17th October 2019",
    eventSpeakerName:"Green ChemisTree Foundation Team    ",
    eventSpeakerOrganization:'Green ChemisTree Foundation Team   ',
...
session3InfoScreen = () => {
  this.props.navigation.navigate('InaugurationD2TechnicalSession', {
    eventName: "Day II: Keynote Address: Going green in chemistry – the Clariant innovation journey    ",
    eventBody: "Day II: Keynote Address: Going green in chemistry – the Clariant innovation journey    "   ,
    eventLocation:"",
    eventDate: "17th October 2019",
    eventSpeakerName:"Dr. Johannes Benkhoff",
    eventSpeakerImage:'http://165.22.216.45/wp-content/uploads/2019/10/Dr.-Johannes-Benkhoff.png',
          ...
          <LinearGradient colors={['#88BE49','#447A47']} style={{alignSelf:'stretch'}}>
                  ...
                  <Body style={{flex:1}}>
                      <View style={{flexDirection:'column',marginLeft:9,marginRight:-60,paddingTop:15,marginBottom:15}}>
                            <View>
                 <Text style={{width:widthPercentageToDP('60%'),fontSize: themes.fonts.INIT_FONT_SIZE_XL,color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family,marginRight:-50}}>
                 Day II: Keynote Address: Going green in chemistry – the Clariant innovation journey
                 </Text>
                 </View>
                <View>
                  <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_L,paddingTop:5,color: themes.colors.INIT_COLOR_Indigo,fontFamily: themes.fonts.INIT_FONT_Family}}>
...
const TabNavigator = createBottomTabNavigator(  
  {  
    ...
    Home:{  
      screen:InaugurationD2TechnicalAndSpecialEvents,  
      navigationOptions:{ 
        tabBarLabel:'Home',  
