...
export default class BioCatalysisTechnicalSession extends Component {
    ...
    return (
      <Container style ={styles.container}>
        <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} colors={['#88BE49', '#447A47']} style={styles.LinearGradient}>
          ...
          <Content>
          <TouchableWithoutFeedback onPress={() => this.props.navigation.navigate('BioCatalysisAbstract')}>
