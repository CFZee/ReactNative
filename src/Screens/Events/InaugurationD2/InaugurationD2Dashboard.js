...
import InaugurationD2TechnicalSession from './InaugurationD2TechnicalSession'; 
import InaugurationD2AboutTheEvent from './InaugurationD2AboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import InaugurationD2Abstract from './InaugurationD2Abstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import InaugurationD2AbstractDetail from './InaugurationD2AbstractDetail';
...
import InaugurationD2TechnicalAndSpecialEvents from './InaugurationD2TechnicalAndSpecialEvents'
...
export class InaugurationD2Dashboard extends Component {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                <Button style={{height:heightPercentageToDP('10%'),width:widthPercentageToDP('10%')}} transparent onPress={() => this.props.navigation.dispatch(StackActions.popToTop())}>
                    ...
                    <Body style={{flex:1,marginLeft:60,alignSelf:'center'}}>
                        <Text style={{alignItems:'center',marginLeft:-50,marginLeft:-50,color:themes.colors.INIT_COLOR_White,width:widthPercentageToDP('85%'),fontFamily:themes.fonts.INIT_FONT_Family,fontSize:14}} >IGCW2019 (Day II)-Inauguration Ceremony</Text>
                        </Body>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('InaugurationD2TechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('InaugurationD2Abstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('InaugurationD2AboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const InaugurationD2TechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:InaugurationD2TechnicalAndSpecialEvents},
  InaugurationD2TechnicalSession:{screen:InaugurationD2TechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    InaugurationD2AboutTheEvent:{
      screen:InaugurationD2AboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const InaugurationD2AbstractNav = createStackNavigator(
  {
    Home: {
      screen: InaugurationD2Abstract,
    },
    Search:{
      screen:Search
    },
    InaugurationD2AbstractDetail:{
      screen:InaugurationD2AbstractDetail
    },
    InaugurationD2AboutTheEvent: {
      screen:InaugurationD2AboutTheEvent,
  },
...
const InaugurationD2AboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: InaugurationD2AboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    InaugurationD2AboutTheEvent:{
      screen:InaugurationD2AboutTheEventNav
    },
    InaugurationD2TechnicalAndSpecialEvents: {
      screen: InaugurationD2TechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  InaugurationD2Abstract:{
    screen:InaugurationD2AbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
