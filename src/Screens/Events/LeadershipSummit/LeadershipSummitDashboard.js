...
import LeadershipSummitTechnicalSession from './LeadershipSummitTechnicalSession'; 
import LeadershipSummitAboutTheEvent from './LeadershipSummitAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import LeadershipSummitAbstract from './LeadershipSummitAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import LeadershipSummitAbstractDetail from './LeadershipSummitAbstractDetail';
...
import LeadershipSummitTechnicalAndSpecialEvents from './LeadershipSummitTechnicalAndSpecialEvents'
...
export class LeadershipSummitDashboard extends Component {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('LeadershipSummitTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('LeadershipSummitAbstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('LeadershipSummitAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const LeadershipSummitTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:LeadershipSummitTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  LeadershipSummitAbstract:{
    screen:LeadershipSummitAbstract
  },
  LeadershipSummitAbstractDetail:{
    screen:LeadershipSummitAbstractDetail
  },
  LeadershipSummitTechnicalSession:{screen:LeadershipSummitTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    LeadershipSummitAboutTheEvent:{
      screen:LeadershipSummitAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const LeadershipSummitAbstractNav = createStackNavigator(
  {
    Home: {
      screen: LeadershipSummitAbstract,
    },
...
const LeadershipSummitAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: LeadershipSummitAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    LeadershipSummitAboutTheEvent:{
      screen:LeadershipSummitAboutTheEventNav
    },
    LeadershipSummitTechnicalAndSpecialEvents: {
      screen: LeadershipSummitTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  LeadershipSummitAbstract:{
    screen:LeadershipSummitAbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
