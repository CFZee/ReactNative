...
export default class BiomimicryAboutTheEvent extends Component {
    ...
    return (
      <Container style={styles.container}>
          ...
          <Content style={styles.shadow,{paddingTop:45}}>
            <Card style={styles.shadow}>
              <CardItem style={{paddingLeft:5,paddingTop:5}}>
      <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_M,fontFamily:themes.fonts.INIT_FONT_Family}}>Workshop on Biomimicry
</Text>
      </CardItem>
      <CardItem style={{paddingLeft:5,paddingTop:2,paddingTop:5}}>
      <Left >
        ...
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/>
        <Text style={{paddingLeft:10,fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>IIT-B</Text>
          </Left>
          </CardItem>
          <CardItem style={{paddingLeft:5,paddingTop:5}}>
            <Text style={{fontFamily:themes.fonts.INIT_FONT_Family,fontSize:themes.fonts.INIT_FONT_SIZE_M}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To introduce the basic concept, fundamentals and potential applications of Biomimicry. To learn how Nature does chemistry and the possibility of solving our challenges using Nature's principles. Case Studies on Green Chemistry solutions through Biomimicry. To share the Biomimicry methodology and how it can be used to innovate products & processes.
              </Text>
          </CardItem>
