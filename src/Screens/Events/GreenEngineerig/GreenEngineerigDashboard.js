...
import GreenEngineerigTechnicalSession from './GreenEngineerigTechnicalSession'; 
import GreenEngineerigAboutTheEvent from './GreenEngineerigAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import GreenEngineerigAbstract from './GreenEngineerigAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import GreenEngineerigAbstractDetail from './GreenEngineerigAbstractDetail';
...
import GreenEngineerigTechnicalAndSpecialEvents from './GreenEngineerigTechnicalAndSpecialEvents'
...
export class GreenEngineerigDashboard extends Component {
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('GreenEngineerigTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('GreenEngineerigAbstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('GreenEngineerigAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const GreenEngineerigTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:GreenEngineerigTechnicalAndSpecialEvents},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  GreenEngineerigAbstract:{
    screen:GreenEngineerigAbstract
  },
  GreenEngineerigAbstractDetail:{
    screen:GreenEngineerigAbstractDetail
  },
  GreenEngineerigTechnicalSession:{screen:GreenEngineerigTechnicalSession},
  SpeakerModerator:{
...
const FavoritesNav = createStackNavigator(
  {
    ...
    GreenEngineerigAboutTheEvent:{
      screen:GreenEngineerigAboutTheEvent
    }
  },
  {
    initialRouteName: 'Home',
...
const GreenEngineerigAbstractNav = createStackNavigator(
  {
    Home: {
      screen: GreenEngineerigAbstract,
    },
...
const GreenEngineerigAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: GreenEngineerigAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    GreenEngineerigAboutTheEvent:{
      screen:GreenEngineerigAboutTheEventNav
    },
    GreenEngineerigTechnicalAndSpecialEvents: {
      screen: GreenEngineerigTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
  ...
  GreenEngineerigAbstract:{
    screen:GreenEngineerigAbstractNav
},
Attendees:{
  screen:AttendeesNav
  },
