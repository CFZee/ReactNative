...
export default class InaugurationTechnicalSession1 extends Component {
  render() {
    ...
    const speaker_name4 = navigation.getParam('eventSpeakerName4');
    const speaker_designation4 = navigation.getParam('eventSpeakerDesignation4');
    const speaker_organisation4 = navigation.getParam('eventSpeakerOrganization4');
    const speaker_image4 = navigation.getParam('eventSpeakerImage4');
...
<Separator transparent style={styles.container2}>
          ...
          <CardItem>
          <Left style={{flex:1,padding:5}}>
            <Thumbnail source = {{uri:speaker_image4}} style={{alignSelf:'center'}}/>
           </Left>
          <Body style={{alignSelf:'center',marginLeft:-60}}>
          <Text style={{fontSize: themes.fonts.INIT_FONT_SIZE_XL,color: themes.colors.INIT_COLOR_Blue,fontFamily: themes.fonts.INIT_FONT_Family,marginRight:-50}}> {speaker_name4} </Text>
          <Text style={{paddingTop:5,fontSize: themes.fonts.INIT_FONT_SIZE_M,color: themes.colors.INIT_COLOR_Grey,fontFamily: themes.fonts.INIT_FONT_Family,width:widthPercentageToDP('65%')}}> {speaker_designation4} </Text>
          <Text style={{paddingTop:5,fontSize: themes.fonts.INIT_FONT_SIZE_M,color: themes.colors.INIT_COLOR_Grey,fontFamily: themes.fonts.INIT_FONT_Family,width:widthPercentageToDP('60%')}}> {speaker_organisation4} </Text>
