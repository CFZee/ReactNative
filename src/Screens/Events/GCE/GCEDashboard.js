...
import GCETechnicalSession from './GCETechnicalSession'; 
import GCEAboutTheEvent from './GCEAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import GCEAbstract from './GCEAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import GCEAbstractDetail from './GCEAbstractDetail';
...
import GCETechnicalAndSpecialEvents from './GCETechnicalAndSpecialEvents'
...
export class GCEDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('GCETechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('GCEAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('GCEAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const GCETechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:GCETechnicalAndSpecialEvents},
  GCETechnicalSession:{screen:GCETechnicalSession},
  SpeakerDetail:{
...
const GCEAbstractNav = createStackNavigator(
  {
    Home: {
      screen: GCEAbstract,
    },
...
const GCEAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: GCEAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    GCEAboutTheEvent:{
      screen:GCEAboutTheEventNav
    },
    GCETechnicalAndSpecialEvents: {
      screen: GCETechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
