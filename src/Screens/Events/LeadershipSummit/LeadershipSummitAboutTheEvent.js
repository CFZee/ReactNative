...
export default class LeadershipSummitAboutTheEvent extends Component {
    ...
    return (
      ...
      <Left >
        ...
        <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To share various global and local realities being faced by Chemical Industry in the domain of environment and sustainability. To share various business, regulatory, supply chain dynamics happening at global level.	To share Green Chemistry initiatives, successful case studies, tools, techniques & best practices to achieve Sustainability.	To inspire & empower Indian Chemical Industry to adopt Green Chemistry  as a tool to achieve Sustainability. To identify challenges, gaps, mindset issues and suggest way forward. Also, share expectations from Supply Chain in India.		
              </Text>
          </CardItem>
