    ...
    return (
      ...
      <Left >
        ...
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/><Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>Seminar Hall 02</Text>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To share global environmental realities, changing regulatory landscape & relevance of EHS in today's business scenario.	To share context, framework, initiatives & best practices in the domain of EHS.	To share importance of Process Safety & possibility to achieve inherent safety using Green Chemistry. To share successful case studies & introduce new innovative solution providers in the domain of EHS.		
              </Text>
          </CardItem>
