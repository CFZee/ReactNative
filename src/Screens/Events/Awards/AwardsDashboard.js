...
import AwardsTechnicalSession from './AwardsTechnicalSession'; 
import AwardsTechnicalSession1 from './AwardsTechnicalSession1'; 
import AwardsTechnicalSession2 from './AwardsTechnicalSession2'; 
import AwardsAboutTheEvent from './AwardsAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import AwardsAbstract from './AwardsAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import AwardsAbstractDetail from './AwardsAbstractDetail';
...
import AwardsTechnicalAndSpecialEvents from './AwardsTechnicalAndSpecialEvents'
...
export class AwardsDashboard extends Component {
    ...
    render() {
      ...
      return(
        ...
        <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 1}} colors={['#88BE49','#447A47']} style={{flex:1}}>
            ...
            <Header transparent androidStatusBarColor='transparent' style={{height:100}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('AwardsTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('AwardsAbstract')}>
            ...
            onPress={() => this.props.navigation.navigate('AwardsAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const AwardsTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:AwardsTechnicalAndSpecialEvents},
  AwardsAbstract:{
    screen:AwardsAbstract
  },
  AwardsAbstractDetail:{
    screen:AwardsAbstractDetail
  },
  AwardsTechnicalSession:{screen:AwardsTechnicalSession},
  AwardsTechnicalSession1:{screen:AwardsTechnicalSession1},
  AwardsTechnicalSession2:{screen:AwardsTechnicalSession2},
  SpeakerDetail:{
...
const AwardsAbstractNav = createStackNavigator(
  {
    Home: {
      screen: AwardsAbstract,
    },
...
const AwardsAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: AwardsAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    AwardsAboutTheEvent:{
      screen:AwardsAboutTheEventNav
    },
    AwardsTechnicalAndSpecialEvents: {
      screen: AwardsTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
