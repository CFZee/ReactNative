...
export default class PollutionAboutTheEvent extends Component {
...
//       <Text style={{fontWeight:'bold',fontSize:themes.fonts.INIT_FONT_SIZE_XL,fontFamily:themes.fonts.INIT_FONT_Family}}>
    ...
    return (
      <Container style={styles.container}>
          ...
          <Content style={styles.shadow,{paddingTop:45}}>
            <Card style={styles.shadow}>
              <CardItem style={{paddingLeft:5,paddingTop:5}}>
      <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_M,fontFamily:themes.fonts.INIT_FONT_Family}}>Conference on "Green Chemistry for Pollution Prevention at Source" for PCB Officers & other Government Bodies
      ...
      <Left >
        ...
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/><Text style={{paddingLeft:10,fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>Seminar Hall 02</Text>
          </Left>
          </CardItem>
          <CardItem style={{paddingLeft:5,paddingTop:5}}>
            <Text style={{fontFamily:themes.fonts.INIT_FONT_Family,fontSize:themes.fonts.INIT_FONT_SIZE_M}}>
