...
export default class NewsAndUpdate extends Component{
    static navigationOptions = ({ navigation }) => ({
        title: 'Certificates & Acknowledgement',
        size:10,
            ...
            <View style={styles.container}>
               <StatusBar backgroundColor='transparent'></StatusBar>
                <View style={styles.topBar}>
                   ...
                   <Text style={styles.topTxt}>Certificates & Acknowledgement Screen</Text>
