...
import PharmaTechnicalSession from './PharmaTechnicalSession'; 
import PharmaAboutTheEvent from './PharmaAboutTheEvent';
import SponsorsPartnerExhibitor from '../../sponsorspartnerexhibitor';
import Favorites from '../../Favorites';
import Speakers from '../../Speakers';
import PharmaAbstract from './PharmaAbstract';
import Attendees from '../../Attendees';
import MeetingsAndEvents from '../../MeetingsAndEvents';
import AboutIGCW from '../../AboutIGCW';
import Events from '../../Events';
import PharmaAbstractDetail from './PharmaAbstractDetail';
...
import PharmaTechnicalAndSpecialEvents from './PharmaTechnicalAndSpecialEvents'
            ...
            <Left style={{flex:1,alignSelf:'center'}}>
                ...
                <Content>
                    ...
                    <View style={{flexDirection:'row',paddingTop:5}}>
                        ...
                        onPress={()  => this.props.navigation.navigate('PharmaTechnicalAndSpecialEvents')}>
                        ...
                        <Card style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),alignItems:'center',justifyContent:'center',borderRadius:10}}>
                        <Button transparent style={{height:heightPercentageToDP('15%'),width:widthPercentageToDP('27%'),justifyContent:'space-around'}}
                         onPress={()  => this.props.navigation.navigate('PharmaAbstract')}>
                        ...
                        <Button rounded style={{marginTop:15,marginLeft: 15,padding:5,marginRight: 15,flex:1,backgroundColor:'#fff'}}onPress={() => this.props.navigation.navigate('PharmaAboutTheEvent')}>
                            <Left style={{flex:1,alignSelf:'center'}}/>
...
const PharmaTechnicalAndSpecialEventsNav = createStackNavigator ({
  Home:{screen:PharmaTechnicalAndSpecialEvents},
  PharmaTechnicalSession:{screen:PharmaTechnicalSession},
  SpeakerDetail:{
    screen:SpeakerDetail
  },
  PharmaAbstract:{
    screen:PharmaAbstract
  },
  PharmaAbstractDetail:{
    screen:PharmaAbstractDetail
  },
  SpeakerModerator:{
...
const PharmaAbstractNav = createStackNavigator(
  {
    Home: {
      screen: PharmaAbstract,
    },
...
const PharmaAboutTheEventNav = createStackNavigator(
  {
    Home: {
      screen: PharmaAboutTheEvent,
    },
...
const AttendeesNav = createStackNavigator(
  ...
  const AppStackNavigator = createStackNavigator({
    ...
    PharmaAboutTheEvent:{
      screen:PharmaAboutTheEventNav
    },
    PharmaTechnicalAndSpecialEvents: {
      screen: PharmaTechnicalAndSpecialEventsNav,
    },
    Tab:{
      screen:TabNavigator
    },
