...
export default class EHSAboutTheEvent extends Component {
...
//   );
  ...
  render() {
    return (
      ...
      <Left >
        <Icon name ='calendar' style={{fontSize:20,color:themes.colors.INIT_COLOR_Green}}/>
        <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>Day 1, 16th October</Text>
        </Left></CardItem>
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/><Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family,paddingLeft:10}}>Seminar Hall 02</Text>
          </Left>
          </CardItem>
          <CardItem style={{paddingLeft:5,paddingTop:5}}>
            <Text style={{fontFamily:themes.fonts.INIT_FONT_Family,fontSize:themes.fonts.INIT_FONT_SIZE_M}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To share about ACS-Green Chemistry Institute Pharmaceutical Roundtable, their commitment & initiatives for Pharmaceutical Industry. To introduce Green Chemistry Metric system including PMI (being used by global pharmaceutical companies). To introduce Green Chemistry tools like Solvent Selection Guide & Reagent Selection Guide. To share successful case studies of Green Chemistry implementation at Merck, Pfizer & Bristol Myers-Squibb.		
              </Text>
          </CardItem>
