...
export default class SPCIAboutTheEvent extends Component {
    ...
    return (
      ...
      <Left >
        ...
        <CardItem style={{paddingLeft:8,paddingTop:-5}}>
          <Left>
        <Icon name ='placeholder' style={{fontSize:themes.fonts.INIT_FONT_SIZE_IconSize_M,color:themes.colors.INIT_COLOR_Green}}/>
        <Text style={{paddingLeft:10,fontSize:themes.fonts.INIT_FONT_SIZE_S,color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}> Seminar Hall 15</Text>
          </Left>
          </CardItem>
          <CardItem style={{paddingLeft:5,paddingTop:5}}>
            <Text style={{fontFamily:themes.fonts.INIT_FONT_Family,fontSize:themes.fonts.INIT_FONT_SIZE_M}}>
          ...
          <CardItem style={{paddingLeft:5,paddingTop:-2,paddingBottom:5,marginRight:-15}}>
            <Text style={{fontSize:themes.fonts.INIT_FONT_SIZE_S,textAlign:'auto',color:themes.colors.INIT_COLOR_Grey,fontFamily:themes.fonts.INIT_FONT_Family}}>
            To share various business, regulatory, supply chain dynamics happening globally in Speciality & Fine Chemicals Industry related to sustainability. To share Green Chemistry initiatives, successful case studies, tools, techniques & best practices by large Speciality & Fine Chemicals companies. To share recent innovations like Flow Chemistry & its successful implementation in Speciality & Fine Chemicals Industry.	To introduce new innovative green chemistry & engineering/environmental solution providers.	To identify challenges, gaps & mindset issues in implementing Green Chemistry and way forward for Speciality & Fine Chemicals Industry.		
              </Text>
          </CardItem>
